    ...
    <main>
        ...
        <div className="container">
          <div className="conexao-hero-inner conexao-hero-entrada">
            ...
            <p>
              ...
              Igreja Católica e aprofundar o relacionamento com Jesus e Maria.
              Um momento de aprendizado, amizade e comunhão, onde a
              evangelização acontece de forma simples, acolhedora e verdadeira.
            </p>
            <div className="proxima-badge">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                strokeWidth="2"
              ...
              Próxima edição em breve — acompanhe nossas redes
            </div>
          </div>
        </div>
      </section>
      <section className="secao">
        <div className="container">
          ...
          <ConnectionsView />
          <ScrollReveal>
            <div className="faixa-proxima">
            <div className="faixa-proxima-texto">
              <span className="rotulo">Não perca a próxima</span>
              <h3>Conexão Pacis Princeps</h3>
              <p>
            ...
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
              ...
              <Link
                ...
                style={{
                  ...
                  color: "var(--marfim)",
                  border: "1.5px solid rgba(255,250,243,.25)",
                }}
              >
                Ver produtos
              </Link>

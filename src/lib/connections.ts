...
export type Connection = { id:string;title:string;theme:string;preacher:string;role:string;date:string;summary:string;content:string;photos:string[];images:ProductImage[];published:boolean;updatedAt:string };
